...
@Entity
@Table(name="claimdoc")
public class ClaimDoucment implements Serializable {
	...
	public ClaimDoucment(String claimFormDulySigned, String copyOfTheClaimIntimation, String hospitalMainBill,
